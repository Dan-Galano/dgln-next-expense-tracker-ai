...
const AddRecord = () => {
  ...
  const [amount, setAmount] = useState<number | string>(50); // Default value for expense amount
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                max="10000"
                step="0.01"
                value={amount} // Set value to empty string if amount is 0
                onChange={(e) => {
                  const value = e.target.value;
                  if (value === "") {
                    setAmount(""); // Set state to empty string
                  } else {
                    setAmount(parseFloat(value)); // Parse value as a float
                  }
                }}
